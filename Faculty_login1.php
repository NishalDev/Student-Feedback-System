...
if (isset($save)) {
  ...
  if ($e == "" || $p == "") {
    ...
    $sql = mysqli_query($conn, "select * from fac_regi where Fac_email='$e' and Fac_pass='$p'");
      ...
      <div class="panel panel-default" style="padding: 50px 20px">
        ...
        <form id="signup" method="post">
          ...
          <div class="form-group">
            <input type="email" class="form-control" id="inputEmail" style="color:white;font-size: 16px"
          ...
          <div class="form-group">
            <input type="password" class="form-control" id="inputPassword" style="color:white;font-size: 16px"
              placeholder="Password" name="p" required>
          </div>
